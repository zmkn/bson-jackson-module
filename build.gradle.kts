    ...
    configure<PublishingExtension> {
        publications {
            create<MavenPublication>("mavenJava") {
                ...
                pom {
                    name.set("Bson Jackson Module")
                    description.set("Bson module for Jackson")
                    url.set("https://github.com/zmkn/bson-jackson-module")
                    inceptionYear.set("2025")
                    licenses {
                        license {
                            name.set("MIT License")
                            url.set("https://github.com/zmkn/bson-jackson-module/blob/master/LICENSE")
                        }
                    }
                    developers {
                        developer {
                    ...
                    scm {
                        connection.set("scm:git:https://github.com/zmkn/bson-jackson-module.git")
                        developerConnection.set("scm:git:git@github.com:zmkn/bson-jackson-module.git")
                        url.set("https://github.com/zmkn/bson-jackson-module")
                    }
                }
            }
...
if (localProperties.getProperty("jreleaser.enable") == "true") {
    ...
    configure<org.jreleaser.gradle.plugin.JReleaserExtension> {
        project {
            ...
            // A list of tags.
            tags.addAll(listOf("bson", "jackson"))
            ...
            links {
                homepage.set("https://github.com/zmkn/bson-jackson-module")
                documentation.set("https://github.com/zmkn/bson-jackson-module/wiki")
                license.set("https://github.com/zmkn/bson-jackson-module/blob/master/LICENSE")
                bugTracker.set("https://github.com/zmkn/bson-jackson-module/issues")
                donation.set("https://github.com/zmkn/bson-jackson-module")
            }
        }
        signing {
            ...
            maven {
                github {
                    create("github") {
                        ...
                        url.set("https://maven.pkg.github.com/zmkn/bson-jackson-module")
